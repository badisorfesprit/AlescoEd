...
@FXML
    ...
    String mdp = txtemail.getText();
     ...
     @FXML
    private void controle_username(KeyEvent event) {       
    ...
    if((u.equals("")))
            ...
            lbl2.setTextFill(Color.web("#b52727  "));
            btnSave.setDisable(true);
            }
     else{ lbl2.setText("");
      ...
      btnSave.setDisable(true);}
        ...
        if(u.length()>10) {lbl2.setText("*max 10 lettres");
            lbl2.setTextFill(Color.web("#b52727  "));
      btnSave.setDisable(true);}
    ...
    if((u.equals("")))
      ...
      btnSave.setDisable(true);}
         ...
         if(u.length()>10) {lbl3.setText("*max 10 lettres");
            lbl3.setTextFill(Color.web("#b52727  "));
      btnSave.setDisable(true);}
